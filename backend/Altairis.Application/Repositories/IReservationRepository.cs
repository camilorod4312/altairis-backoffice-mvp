...
{
    Task<(int total, List<ReservationListItemDto> items)> ListAsync(int? hotelId, string? query, DateOnly? from, DateOnly? to, int page, int pageSize, CancellationToken ct);
