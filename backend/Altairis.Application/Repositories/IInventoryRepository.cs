...
{
    Task<(int total, List<InventoryEntryDto> items)> ListAsync(IReadOnlyList<int>? hotelIds, int? roomTypeId, DateOnly? from, DateOnly? to, int page, int pageSize, CancellationToken ct);
